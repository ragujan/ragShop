...
public class BrandReg extends javax.swing.JDialog {
    ...
    private void jTextField1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusGained
        ...
        if (jTextField1.getText().equals("Brand_Name")) {
            jTextField1.setText("");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (text.isEmpty() || text.equals("Brand_Name")) {
            ...
            try {
                ResultSet rs = MySql.sq("SELECT * FROM `brand` WHERE `brand_name`='" + text + "'");
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "This brand already exits ", "Warning", JOptionPane.WARNING_MESSAGE);

                } else {
                    MySql.iud("INSERT INTO `brand` (`brand_name`) VALUES ('" + text + "')");
                    loadCatTable();
                    jTextField1.setText("");
                    mp.loadBrands();
                    this.dispose();
